"""
This file downloads videos from the HDTF dataset using yt-dlp. It processes videos based on the dataset's requirements, including downloading, cutting, and cropping functionalities.
